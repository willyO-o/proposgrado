!(function (t, e) {
		...
		for (var t = 1; t < arguments.length; t++) {
			...
			t % 2
				? e(Object(o), !0).forEach(function (t) {
						var e, i;
						(e = n), (t = o[(i = t)]), i in e ? Object.defineProperty(e, i, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : (e[i] = t);
				  })
	...
	var s = {
		...
		v = ''.concat(g, '-fade'),
		p = ''.concat(g, '-fixed'),
		b = ''.concat(g, '-fullscreen'),
		h = ''.concat(g, '-fullscreen-exit'),
		w = ''.concat(g, '-hide'),
		y = ''.concat(g, '-hide-md-down'),
		...
		F = 'keydown',
		N = 'load',
		Y = r ? 'pointerdown' : a ? 'touchstart' : 'mousedown',
		X = r ? 'pointermove' : a ? 'touchmove' : 'mousemove',
		M = r ? 'pointerup pointercancel' : a ? 'touchend touchcancel' : 'mouseup',
		q = 'resize',
		P = 'transitionend',
		W = 'wheel',
		j = 'ready',
	...
	function ot(e, i) {
		if (e && nt(i))
			if (Array.isArray(e) || J(e.length)) for (var t = e.length, n = 0; n < t && !1 !== i.call(e, e[n], n, e); n += 1);
			else
				tt(e) &&
	...
	var vt,
		...
		bt =
			...
			t &&
				...
				n.addEventListener('test', St, Ot),
				n.removeEventListener('test', St, Ot)),
			pt);
	function wt(i, t, n, e) {
		...
		t.trim()
			...
			.forEach(function (t) {
				var e;
				bt || ((e = i.listeners) && e[t] && e[t][n] && ((s = e[t][n]), delete e[t][n], 0 === Object.keys(e[t]).length && delete e[t], 0 === Object.keys(e).length && delete i.listeners)), i.removeEventListener(t, s, o);
			});
	}
	function yt(s, t, a, e) {
	...
	function xt(t, e, i, n) {
		var o;
		return nt(Event) && nt(CustomEvent) ? (o = new CustomEvent(e, l({ bubbles: !0, cancelable: !0, detail: i }, n))) : (o = document.createEvent('CustomEvent')).initCustomEvent(e, !0, !0, i), t.dispatchEvent(o);
	}
	function kt(t) {
		var e = t.rotate,
			i = t.scaleX,
	...
	function Dt(i, t, e) {
		...
		return (
			...
			(n.src = i.src),
			zt || ((n.style.cssText = 'left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;'), o.appendChild(n)),
			n
		);
	}
	function Tt(t) {
	...
	var It,
		At = {
			...
			initViewer: function () {
				var t,
					e = this.options,
					i = this.parent;
				e.inline && ((t = { width: Math.max(i.offsetWidth, e.minWidth), height: Math.max(i.offsetHeight, e.minHeight) }), (this.parentData = t)), (!this.fulled && t) || (t = this.containerData), (this.viewerData = st({}, t));
			},
			...
			initList: function () {
				var r = this,
					...
					c = [];
				(l.innerHTML = ''),
					ot(this.images, function (i, t) {
						var e,
							n,
							o = i.src,
							s = i.alt || (_((e = o)) ? decodeURIComponent(e.replace(/^.*\//, '').replace(/[?&#].*$/, '')) : ''),
							a = r.getImageURL(i);
						(o || a) &&
							((e = document.createElement('li')),
							(n = document.createElement('img')),
							ot(h.inheritedAttributes, function (t) {
								var e = i.getAttribute(t);
								null !== e && n.setAttribute(t, e);
							}),
							(n.src = o || a),
					...
					ot((this.items = c), function (e) {
						...
						ft(t, 'filled', !0),
							...
							yt(
								...
								N,
								function (t) {
									h.loading && ct(e, T), r.loadImage(t);
								},
								{ once: !0 }
							);
					}),
			...
			renderList: function () {
				var t = this.index,
					...
					i = e.offsetWidth,
					e = i + n;
				rt(this.list, st({ width: e * this.length - n }, kt({ translateX: (this.viewerData.width - i) / 2 - e * t })));
			},
			resetList: function () {
				var t = this.list;
				(t.innerHTML = ''), ct(t, S), rt(t, kt({ translateX: 0 }));
			},
				...
				(this.imageInitializing = {
					...
					(t = Dt(e, l, function (t, e) {
						...
						var n = Math.min(0.9 * n, t),
							...
							s = (c - n) / 2,
							a = (u - o) / 2,
							t = { left: s, top: a, x: s, y: a, width: n, height: o, oldRatio: 1, ratio: n / t, aspectRatio: i, naturalWidth: t, naturalHeight: e },
							e = st({}, t);
			...
			renderImage: function (t) {
				var e,
					...
					n = this.image,
					o = this.imageData;
				rt(n, st({ width: o.width, height: o.height, marginLeft: o.x, marginTop: o.y }, kt(o))),
					t &&
						((this.viewing || this.moving || this.rotating || this.scaling || this.zooming) && this.options.transition && ht(n, S)
							? ((e = function () {
		...
		r = {
			bind: function () {
				...
				yt(e, O, (this.onClick = this.click.bind(this))),
					yt(e, L, (this.onDragStart = this.dragstart.bind(this))),
					yt(i, Y, (this.onPointerDown = this.pointerdown.bind(this))),
					yt(n, X, (this.onPointerMove = this.pointermove.bind(this))),
					yt(n, M, (this.onPointerUp = this.pointerup.bind(this))),
					yt(n, F, (this.onKeyDown = this.keydown.bind(this))),
					yt(window, q, (this.onResize = this.resize.bind(this))),
					t.zoomable && t.zoomOnWheel && yt(e, W, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
			...
			unbind: function () {
				var t = this.options,
					...
					i = this.canvas,
					n = this.element.ownerDocument;
				wt(e, O, this.onClick), wt(e, L, this.onDragStart), wt(i, Y, this.onPointerDown), wt(n, X, this.onPointerMove), wt(n, M, this.onPointerUp), wt(n, F, this.onKeyDown), wt(window, q, this.onResize), t.zoomable && t.zoomOnWheel && wt(e, W, this.onWheel, { passive: !1, capture: !0 }), t.toggleOnDblclick && wt(i, C, this.onDblclick);
			},
		},
		t = {
			click: function (t) {
					...
					this.initImage(function () {
						ut(n, E, i.movable),
							...
							t.renderImage(function () {
								(t.viewed = !0), (t.viewing = !1), nt(i.viewed) && yt(e, V, i.viewed, { once: !0 }), xt(e, V, { originalImage: t.images[o], index: o, image: n }, { cancelable: !1 });
							});
					});
			},
			loadImage: function (t) {
				...
				Dt(n, this.options, function (t, e) {
					var i = t / e,
						t = o,
						e = s;
					o < s * i ? (a ? (t = s * i) : (e = o / i)) : a ? (e = o / i) : (t = s * i), rt(n, st({ width: t, height: e }, kt({ translateX: (o - t) / 2, translateY: (s - e) / 2 })));
				});
			},
			keydown: function (t) {
				var e = this.options;
				if (e.keyboard) {
					...
					if ((13 === i && this.viewer.contains(t.target) && this.click(t), this.fulled))
						switch (i) {
							case 27:
			...
			pointerdown: function (t) {
				...
				!this.viewed ||
					...
					this.viewing ||
					this.hiding ||
					(('mousedown' === t.type || ('pointerdown' === t.type && 'mouse' === t.pointerType)) && ((J(n) && 1 !== n) || (J(o) && 0 !== o) || t.ctrlKey)) ||
					(t.preventDefault(),
					t.changedTouches
					...
					(o = !!e.movable && c),
					e.zoomOnTouch && e.zoomable && 1 < Object.keys(i).length ? (o = d) : e.slideOnTouch && ('touch' === t.pointerType || 'touchstart' === t.type) && this.isSwitchable() && (o = u),
					!e.transition || (o !== c && o !== d) || ct(this.image, S),
					(this.action = o));
			},
			...
			pointerup: function (t) {
				...
				t.changedTouches
					...
					o &&
						(t.preventDefault(),
						!n.transition || (o !== c && o !== d) || lt(this.image, S),
						(this.action = !1),
						a &&
							o !== d &&
							e &&
			...
			resize: function () {
				...
				this.isShown &&
					...
					this.played &&
						(!this.options.fullscreen || !this.fulled || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement
							? ot(this.player.getElementsByTagName('img'), function (t) {
									yt(t, N, e.loadImage.bind(e), { once: !0 }), xt(t, N);
							  })
							: this.stop()));
			},
			wheel: function (t) {
				...
				this.viewed &&
					...
					this.wheeling ||
						...
						(i = 1),
						t.deltaY ? (i = 0 < t.deltaY ? 1 : -1) : t.wheelDelta ? (i = -t.wheelDelta / 120) : t.detail && (i = 0 < t.detail ? 1 : -1),
						this.zoom(-i * e, !0, t)));
			},
		},
		St = {
			show: function () {
				...
				if ((nt(i.show) && yt(e, H, i.show, { once: !0 }), !1 === xt(e, H) || !this.ready)) return this;
			...
			hide: function () {
				...
				if ((nt(n.hide) && yt(e, 'hide', n.hide, { once: !0 }), !1 === xt(e, 'hide'))) return this;
				...
				return (
					n.transition && !t
						? ((o = function t(e) {
								e && e.target === a && (wt(a, P, t), i.hidden());
						  }),
						  (s = function () {
								ht(a, S) ? (yt(a, P, o), ct(a, z)) : h();
						  }),
						  (this.transitioning = {
								abort: function () {
									i.viewed && ht(r, S) ? wt(r, P, s) : ht(a, S) && wt(a, P, o);
								},
						  }),
						  this.viewed && ht(r, S) ? (yt(r, P, s, { once: !0 }), this.zoomTo(0, !1, null, !0)) : s())
						: h(),
					this
				);
			},
			view: function () {
				...
				if (
					(ot(n.inheritedAttributes, function (t) {
						var e = r.getAttribute(t);
						null !== e && c.setAttribute(t, e);
					}),
					(c.src = h),
					(c.alt = l),
					nt(n.view) && yt(e, 'view', n.view, { once: !0 }),
					!1 === xt(e, 'view', { originalImage: this.images[t], index: t, image: c }) || !this.isShown || this.hiding || this.played)
				)
					return this;
				h = this.items[this.index];
				h && (ct(h, m), h.removeAttribute('aria-selected')), lt(a, m), a.setAttribute('aria-selected', !0), n.focus && a.focus(), (this.image = c), (this.viewed = !1), (this.index = t), (this.imageData = {}), lt(c, D), n.loading && lt(s, T), (s.innerHTML = ''), s.appendChild(c), this.renderList(), (o.innerHTML = '');
				function u() {
					var t = i.imageData,
						e = Array.isArray(n.title) ? n.title[1] : n.title;
					o.innerHTML = _((t = nt(e) ? e.call(i, c, t) : ''.concat(l, ' (').concat(t.naturalWidth, ' × ').concat(t.naturalHeight, ')')))
						? t
				...
				return (
					...
					c.complete
						? this.load()
						: (yt(c, N, (d = this.load.bind(this)), { once: !0 }),
			...
			moveTo: function (t) {
				...
				if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && s.movable)) {
					...
					if ((J(t) ? (l = !0) : (t = r), J(i) ? (l = !0) : (i = h), l)) {
						if ((nt(s.move) && yt(o, 'move', s.move, { once: !0 }), !1 === xt(o, 'move', { x: t, y: i, oldX: r, oldY: h, originalEvent: n }))) return this;
						(a.x = t),
							(a.y = i),
							(a.left = t),
							(a.top = i),
							...
							this.renderImage(function () {
								(e.moving = !1), nt(s.moved) && yt(o, 'moved', s.moved, { once: !0 }), xt(o, 'moved', { x: t, y: i, oldX: r, oldY: h, originalEvent: n }, { cancelable: !1 });
							});
					}
				}
				return this;
			...
			rotateTo: function (t) {
				...
				if (J((t = Number(t))) && this.viewed && !this.played && n.rotatable) {
					var s = o.rotate;
					if ((nt(n.rotate) && yt(i, 'rotate', n.rotate, { once: !0 }), !1 === xt(i, 'rotate', { degree: t, oldDegree: s }))) return this;
					(o.rotate = t),
						(this.rotating = !0),
						this.renderImage(function () {
							(e.rotating = !1), nt(n.rotated) && yt(i, U, n.rotated, { once: !0 }), xt(i, U, { degree: t, oldDegree: s }, { cancelable: !1 });
						});
				}
				return this;
			},
			...
			scale: function (t) {
				...
				if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && o.scalable)) {
					...
					if ((J(t) ? (h = !0) : (t = a), J(i) ? (h = !0) : (i = r), h)) {
						if ((nt(o.scale) && yt(n, 'scale', o.scale, { once: !0 }), !1 === xt(n, 'scale', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }))) return this;
						(s.scaleX = t),
							(s.scaleY = i),
							(this.scaling = !0),
							this.renderImage(function () {
								(e.scaling = !1), nt(o.scaled) && yt(n, 'scaled', o.scaled, { once: !0 }), xt(n, 'scaled', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }, { cancelable: !1 });
							});
					}
				}
				return this;
			...
			zoomTo: function (t) {
				...
				if (J((t = Math.max(0, t))) && this.viewed && !this.played && (r || l.zoomable)) {
					r || ((b = Math.max(0.01, l.minZoomRatio)), (w = Math.min(100, l.maxZoomRatio)), (t = Math.min(Math.max(t, b), w)));
					var r = v * (t = a && 0.055 <= l.zoomRatio && 0.95 < t && t < 1.05 ? 1 : t),
						b = p * t,
						w = r - g,
						v = b - f,
						y = u.ratio;
					if ((nt(l.zoom) && yt(h, 'zoom', l.zoom, { once: !0 }), !1 === xt(h, 'zoom', { ratio: t, oldRatio: y, originalEvent: a }))) return this;
					(this.zooming = !0),
						a
							? ((p = { left: (p = (p = this.viewer).getBoundingClientRect()).left + (window.pageXOffset - document.documentElement.clientLeft), top: p.top + (window.pageYOffset - document.documentElement.clientTop) }),
							  (c =
						...
						(u.ratio = t),
						this.renderImage(function () {
							(e.zooming = !1), nt(l.zoomed) && yt(h, 'zoomed', l.zoomed, { once: !0 }), xt(h, 'zoomed', { ratio: t, oldRatio: y, originalEvent: a }, { cancelable: !1 });
						}),
						s && this.tooltip();
				}
				return this;
			...
			play: function () {
				...
				var i = this.element,
					o = this.options;
				if ((nt(o.play) && yt(i, 'play', o.play, { once: !0 }), !1 === xt(i, 'play'))) return this;
				var s = this.player,
				...
				return (
					...
					lt(s, A),
					ot(this.items, function (t, e) {
						var i = t.querySelector('img'),
							n = document.createElement('img');
						(n.src = gt(i, 'originalUrl')), (n.alt = i.getAttribute('alt')), (n.referrerPolicy = i.referrerPolicy), (h += 1), lt(n, v), ut(n, S, o.transition), ht(t, m) && (lt(n, z), (l = e)), r.push(n), yt(n, N, a, { once: !0 }), s.appendChild(n);
					}),
					J(o.interval) &&
						0 < o.interval &&
						1 < h &&
			...
			stop: function () {
				...
				var t = this.element,
					i = this.options;
				if ((nt(i.stop) && yt(t, 'stop', i.stop, { once: !0 }), !1 === xt(t, 'stop'))) return this;
				t = this.player;
				return (
					(this.played = !1),
					clearTimeout(this.playing),
					ot(t.getElementsByTagName('img'), function (t) {
			...
			exit: function () {
				...
				return (
					this.isShown &&
						...
						ct(i, p),
						rt(i, { zIndex: e.zIndexInline }),
						(this.viewerData = st({}, this.parentData)),
						this.renderViewer(),
						this.renderList(),
						this.viewed &&
							this.initImage(function () {
			...
			tooltip: function () {
				...
				return (
					this.viewed &&
						...
						this.tooltipping ? clearTimeout(this.tooltipping) : e.transition ? (this.fading && xt(i, P), lt(i, A), lt(i, v), lt(i, S), i.removeAttribute('aria-hidden'), (i.initialOffsetWidth = i.offsetWidth), lt(i, z)) : (lt(i, A), i.removeAttribute('aria-hidden')),
						(this.tooltipping = setTimeout(function () {
							e.transition
								? (yt(
										...
										P,
										function () {
											ct(i, A), ct(i, v), ct(i, S), i.setAttribute('aria-hidden', !0), (t.fading = !1);
										},
										{ once: !0 }
								  ),
								  ct(i, z),
								  (t.fading = !0))
								: (ct(i, A), i.setAttribute('aria-hidden', !0)),
								(t.tooltipping = !1);
						}, 1e3))),
					this
				);
			...
			update: function () {
				...
				var o,
					s = [];
				return (
					ot(n ? [t] : t.querySelectorAll('img'), function (t) {
					...
					s.length &&
						...
						this.ready
							? ((o = []),
							  ...
							  rt(this.list, { width: 'auto' }),
							  this.initList(),
							  this.isShown && (this.length ? this.viewed && (0 <= (t = o.indexOf(this.index)) ? ((this.viewed = !1), this.view(Math.max(Math.min(this.index - t, this.length - 1), 0))) : (lt((t = this.items[this.index]), m), t.setAttribute('aria-selected', !0))) : ((this.image = null), (this.viewed = !1), (this.index = 0), (this.imageData = {}), (this.canvas.innerHTML = ''), (this.title.innerHTML = ''))))
							: this.build()),
					this
				);
			},
			destroy: function () {
				...
				return (
					t[g] &&
						((this.destroyed = !0),
						this.ready
							? (this.played && this.stop(), e.inline ? (this.fulled && this.exit(), this.unbind()) : this.isShown ? (this.viewing && (this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort()), this.hiding && this.transitioning.abort(), this.hidden()) : this.showing && (this.transitioning.abort(), this.hidden()), (this.ready = !1), this.viewer.parentNode.removeChild(this.viewer))
							: e.inline && (this.delaying ? this.delaying.abort() : this.initializing && this.initializing.abort()),
						e.inline || wt(t, O, this.onStart),
						(t[g] = void 0)),
					this
				);
			},
		...
		Ot = {
			...
			shown: function () {
				var t = this.element,
					e = this.options,
					i = this.viewer;
				(this.fulled = !0), (this.isShown = !0), this.render(), this.bind(), (this.showing = !1), e.focus && (i.focus(), this.enforceFocus()), nt(e.shown) && yt(t, B, e.shown, { once: !0 }), !1 !== xt(t, B) && this.ready && this.isShown && !this.hiding && this.view(this.index);
			},
			hidden: function () {
				var t = this.element,
					e = this.options,
					i = this.viewer;
				e.fucus && this.clearEnforceFocus(), (this.fulled = !1), (this.viewed = !1), (this.isShown = !1), this.close(), this.unbind(), lt(i, w), i.removeAttribute('role'), i.removeAttribute('aria-labelledby'), i.removeAttribute('aria-modal'), i.setAttribute('aria-hidden', !0), this.resetList(), this.resetImage(), (this.hiding = !1), this.destroyed || (nt(e.hidden) && yt(t, 'hidden', e.hidden, { once: !0 }), xt(t, 'hidden', null, { cancelable: !1 }));
			},
				...
				(e = [
					{
						...
						value: function () {
							...
							s[g] ||
								...
								(t = 'img' === s.localName),
								(e = []),
								ot(t ? [s] : s.querySelectorAll('img'), function (t) {
								...
								(this.images = e),
								this.initBody(),
								Q(document.createElement(g).style.transition) && (a.transition = !1),
								a.inline
									? ((i = 0),
									  (n = function () {
											var t;
					...
					},
					{
						...
						value: function () {
							...
							this.ready ||
								...
								(n = (i = d.querySelector('.'.concat(g, '-container'))).querySelector('.'.concat(g, '-title'))),
								(o = i.querySelector('.'.concat(g, '-toolbar'))),
								(a = i.querySelector('.'.concat(g, '-navbar'))),
								(m = i.querySelector('.'.concat(g, '-button'))),
								(d = i.querySelector('.'.concat(g, '-canvas'))),
								(this.parent = e),
								(this.viewer = i),
								(this.title = n),
								(this.toolbar = o),
								...
								(n.id = ''.concat(g, 'Title').concat(this.id)),
								lt(n, s.title ? Tt(Array.isArray(s.title) ? s.title[0] : s.title) : w),
								lt(a, s.navbar ? Tt(s.navbar) : w),
								ut(m, w, !s.button),
								s.keyboard && m.setAttribute('tabindex', 0),
								s.backdrop && (lt(i, ''.concat(g, '-backdrop')), s.inline || 'static' === s.backdrop || ft(d, K, 'hide')),
								_(s.className) &&
									s.className &&
									s.className.split(Z).forEach(function (t) {
										lt(i, t);
									}),
								s.toolbar
									? ((r = document.createElement('ul')),
									  ...
									  (u = $.slice(9)),
									  h || lt(o, Tt(s.toolbar)),
									  ot(h ? s.toolbar : $, function (t, e) {
											var i = h && it(t),
												n = h ? mt(e) : t,
												o = i && !Q(t.show) ? t.show : t;
											!o ||
												(!s.zoomable && -1 !== l.indexOf(n)) ||
												(!s.rotatable && -1 !== c.indexOf(n)) ||
												(!s.scalable && -1 !== u.indexOf(n)) ||
												((e = i && !Q(t.size) ? t.size : t), (i = i && !Q(t.click) ? t.click : t), (t = document.createElement('li')), s.keyboard && t.setAttribute('tabindex', 0), t.setAttribute('role', 'button'), lt(t, ''.concat(g, '-').concat(n)), nt(i) || ft(t, K, n), J(o) && lt(t, Tt(o)), -1 !== ['small', 'large'].indexOf(e) ? lt(t, ''.concat(g, '-').concat(e)) : 'play' === n && lt(t, ''.concat(g, '-large')), nt(i) && yt(t, O, i), r.appendChild(t));
									  }),
									  o.appendChild(r))
									: lt(o, w),
								s.rotatable ||
									(lt((d = o.querySelectorAll('li[class*="rotate"]')), D),
									ot(d, function (t) {
										o.appendChild(t);
									})),
								s.inline ? (lt(m, b), rt(i, { zIndex: s.zIndexInline }), 'static' === window.getComputedStyle(e).position && rt(e, { position: 'relative' }), e.insertBefore(i, t.nextSibling)) : (lt(m, f), lt(i, p), lt(i, v), lt(i, w), rt(i, { zIndex: s.zIndex }), (m = (m = _((m = s.container)) ? t.ownerDocument.querySelector(m) : m) || this.body).appendChild(i)),
								s.inline && (this.render(), this.bind(), (this.isShown = !0)),
								(this.ready = !0),
								nt(s.ready) && yt(t, j, s.ready, { once: !0 }),
								!1 !== xt(t, j) ? this.ready && s.inline && this.view(this.index) : (this.ready = !1));
						},
					},
				]) && o(t.prototype, e),
				n && o(t, n),
