$(function() {
    ...
    function crearComponente(idComponente, eliminarComponente, cantidadComponente, valores) {
        const componente = `<div class="row ${cantidadComponente}" id="${idComponente}">
		...
		<div class="col-11 col-xl-11">
			...
			<div class="row d-flex justify-content-center">
				<div class="col-sm-12 col-md-6 col-xl-6 border">
					...
					<input class="form-control" type="file" id="${valores.nombreImagenAdjunto}" name="${valores.nombreImagenAdjunto}" accept="${extensionesValidasString}" >
    ...
    $('#btn-agregar-deposito-matricula').on('click', function(e) {
        ...
        // $('[name="tipo_deposito_matricula[]"]').trigger('change');
    });

    $("#depositos").on('change', '[name="imagen_matricula[]"]', function(e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $("#depositos").on('click', '.prev_matricula', function(e) {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
    ...
    $("#depositos").on('click', '.eliminar-componente-matricula', function(e) {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
    ...
    $("#depositos").on('change', '[name="tipo_deposito_matricula[]"]', function(e) {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
        idPadre = $(this).closest('.elemento-matricula').attr('id');
    ...
    // $('input[name="tiene_deposito"]').filter(`[value="tiene-deposito"]`).trigger('click');
